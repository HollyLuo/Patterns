package pfv.spmf.algorithms.frequentpatterns.charm;
...
import pfv.spmf.algorithms.ArraysAlgos;
import pfv.spmf.datastructures.triangularmatrix.TriangularMatrix;
import pfv.spmf.input.transaction_database_list_integers.TransactionDatabase;
import pfv.spmf.patterns.itemset_array_integers_with_tids_bitset.Itemset;
...
public class AlgoDCharm_Bitset extends AlgoCharm_Bitset{
	...
	void save(int[] prefix, int[] suffix, BitSetSupport tidset) throws IOException {
		...
		pfv.spmf.patterns.itemset_array_integers_with_count.Itemset itemset = new pfv.spmf.patterns.itemset_array_integers_with_count.Itemset(prefixSuffix);
