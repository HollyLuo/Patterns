package pfv.spmf.algorithms.sequenceprediction.ipredict.controllers;

import java.io.IOException;

import pfv.spmf.algorithms.sequenceprediction.ipredict.helpers.StatsLogger;
import pfv.spmf.algorithms.sequenceprediction.ipredict.predictor.Evaluator;
//import pfv.spmf.algorithms.sequenceprediction.ipredict.predictor.CPT.CPT.CPTPredictor;
//import pfv.spmf.algorithms.sequenceprediction.ipredict.predictor.CPT.CPTPlus.CPTPlusPredictor;
//import pfv.spmf.algorithms.sequenceprediction.ipredict.predictor.DG.DGPredictor;
//import pfv.spmf.algorithms.sequenceprediction.ipredict.predictor.LZ78.LZ78Predictor;
import pfv.spmf.algorithms.sequenceprediction.ipredict.predictor.Markov.MarkovAllKPredictor;
import pfv.spmf.algorithms.sequenceprediction.ipredict.predictor.Markov.MarkovFirstOrderPredictor;
//import pfv.spmf.algorithms.sequenceprediction.ipredict.predictor.TDAG.TDAGPredictor;
/*
