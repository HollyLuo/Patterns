...
import pfv.spmf.algorithmmanager.AlgorithmManager;
import pfv.spmf.algorithmmanager.DescriptionOfAlgorithm;
import pfv.spmf.algorithmmanager.DescriptionOfParameter;
//import pfv.spmf.algorithmmanager.descriptions.DescriptionAlgoClusterViewer;
//import pfv.spmf.algorithms.timeseries.TimeSeries;
//import pfv.spmf.algorithms.timeseries.reader_writer.AlgoTimeSeriesReader;
import pfv.spmf.test.MainTestApriori_saveToFile;
import pfv.spmf.gui.patternvizualizer.PatternVizualizer;
//import pfv.spmf.gui.timeseriesviewer.TimeSeriesViewer;
...
//				            JOptionPane.ERROR_MESSAGE);
		    ...
		    JOptionPane.showMessageDialog(null,
		            "An error occured while opening the output file dialog. ERROR MESSAGE1 = " + e.toString(), "Error",
		            JOptionPane.ERROR_MESSAGE);
		}
		...
		if (succeed  && lblSetOutputFile.isVisible()){
			...
			if(checkboxOpenOutputText.isSelected()) {
			    ...
			    if (desktop.isSupported(Desktop.Action.OPEN)) {
			        try {
			            ...
			            JOptionPane.showMessageDialog(null,
			                    "An error occured while opening the output file. ERROR MESSAGE2 = " + e.toString(), "Error",
			                    JOptionPane.ERROR_MESSAGE);
			        }
			    }
			}
			...
			// if using wants to use the text editor to open the file
				...
				try {
		            ...
		            JOptionPane.showMessageDialog(null,
		                    "An error occured while opening the output file. ERROR MESSAGE3 = " + e.toString(), "Error",
		                    JOptionPane.ERROR_MESSAGE);
		        }
			}
