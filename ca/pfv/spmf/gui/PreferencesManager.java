...
public class PreferencesManager {   
    ...
    public static final String REGKEY_SPMF_INPUT_FILE = "pfv.spmf.gui.input";
    public static final String REGKEY_SPMF_OUTPUT_FILE = "pfv.spmf.gui.output";
    public static final String REGKEY_SPMF_PLUGIN_FOLDER_PATH = "pfv.spmf.plugin.folderpath";
    public static final String REGKEY_SPMF_PREFERED_CHARSET = "pfv.spmf.gui.charset";
